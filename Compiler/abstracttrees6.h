...
#define NODETYPE_PAIR_ID 34
#define NODETYPE_PAIR_LEAF 35
#define NODETYPE_PAIR_ASGN 36
#define NODETYPE_PAIR_COMP_ASGN 37
#define NODETYPE_PAIR_COMP 38
#define NODETYPE_TYPE 39
struct Tnode {
